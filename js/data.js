const MOCK_DATA = {
    ...
    'exception-manage': {
        columns: [
            { label: '上报日期', key: 'reportDate' },
            { label: '患者姓名', key: 'patientName' },
            { label: '患者编号', key: 'patientId' },
            { label: '异常类型', key: 'type' },
            { label: '事件描述', key: 'description' },
            { label: '状态', key: 'status' },
            { label: '上报人', key: 'reporter' },
            { label: '更新时间', key: 'updateTime' }
        ],
        data: [
            { id: 1, reportDate: '2026-05-01', patientName: '吴*珍', patientId: 'ff881b85-bf8b-4ce6...', type: 'AE', description: '皮肤瘙痒', status: '待处理', reporter: '王专员', updateTime: '2026-05-01 10:30' },
            { id: 2, reportDate: '2026-04-28', patientName: '张*', patientId: 'ff4af52c-5894-45ed...', type: 'SAE', description: '严重肺部感染', status: '已上报PV', reporter: '王专员', updateTime: '2026-04-29 09:00' }
        ]
    }
};
